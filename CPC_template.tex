...
\author[a]{Jianxin Liu\corref{author}}
\author[a,b]{Second Author}
\author[b]{Third Author}

\cortext[author] {Corresponding author.\\\textit{E-mail address:} firstAuthor@somewhere.edu}
\address[a]{High Speed Aerodynamics Laboratory, Tianjin University, China}
...
instability; transition; PSE; boundary layer.
...
%{\em Catalogue identifier:}                                   \\
  %Leave blank, supplied by Elsevier.
{\em Licensing provisions:} GPL v3                                  \\
  %enter "none" if CPC non-profit use license is sufficient.
{\em Programming language:} FORTRAN 2008                                  \\
{\em Computer:} Any PC workstation                                              \\
...
{\em Keywords:} instability, transition, PSE, boundary layer.  \\
